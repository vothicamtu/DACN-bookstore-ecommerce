    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>): Promise<void> => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                alert(data.message || validationMessage || 'Đăng ký thất bại');
            }
        } catch (error) {
            ...
            <main className="auth-main">
                ...
                <div className="auth-banner">
                    ...
                    <div className="auth-banner__content">
                        <h1 className="auth-banner__title">Tham gia BookLand</h1>
                        <p className="auth-banner__desc">
                            Tạo tài khoản để khám phá hàng ngàn đầu sách phù hợp với sở thích của bạn. Trở thành một phần của cộng đồng yêu sách tinh tế.
                        </p>
                    </div>
                </div>
                ...
                <div className="auth-form-side">
                    <div className="auth-card--bordered">
                        <div className="auth-card">
                            ...
                            <p className="auth-card__subtitle">Chào mừng bạn đến với BookLand</p>
                            ...
                            <form className="auth-form" onSubmit={handleSubmit}>
                                ...
                                {/* <div className="auth-form__checkbox-wrap" style={{ paddingTop: '8px' }}>
                                <input
                                    type="checkbox"
                                    id="agree"
                                    className="auth-form__checkbox"
                                />
                                <label htmlFor="agree" className="auth-form__checkbox-label">
                                    Tôi đồng ý với <a href="#" className="auth-form__link" style={{ textDecoration: 'underline' }}>điều khoản sử dụng</a>
                                </label>
                            </div>*/}
                            ...
                            <div className="auth-switch-mode--register">
                                <span className="auth-switch-mode__text">Đã có tài khoản? </span>
                                <Link to="/login" className="auth-form__link" style={{fontWeight: 500}}>Đăng nhập</Link>
                            </div>
